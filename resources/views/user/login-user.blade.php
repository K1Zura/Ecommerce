			...
			<div class="row">
				<div class="col-lg-6">
					<div class="login_box_img">
						...
						<div class="hover">
							<h4>Masih Baru Disini?</h4>
							<p>Kamu bisa mendaftarkan akun kalian disini!</p>
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form" action="/auth-user" method="post" id="contactForm" novalidate="novalidate">
							@csrf
